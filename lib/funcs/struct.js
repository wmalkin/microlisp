...
func.def({ name: "push", body: $push, docs: "Push an element onto the front of a list" });
func.def({ name: "pop", body: $pop });
func.def({ name: "pushtail", body: $pushtail });
func.def({ name: "poptail", body: $poptail });
